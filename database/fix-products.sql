-- Venus Enterprises - Fix Products (ONLY Corporate Gifts)
USE venus_db;

-- First, let's see what we have
SELECT 'Current products before fix:' as '';
...
-- Insert ONLY the products you want (NO electronics, clothing, sports, etc.)
...
SELECT 'Products after fix:' as '';
SELECT id, name, category, price FROM products ORDER BY category, name;

-- Verify no incorrect categories remain
SELECT 'Checking for incorrect categories:' as '';
SELECT DISTINCT category FROM products 
WHERE category NOT IN ('Wooden', 'Acrylic', 'Metal', 'Crystal', 'Corporate Gifts', 'Mementos', 'Marble');
